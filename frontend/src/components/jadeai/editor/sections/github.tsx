...
/** 项目后端无 /api/github/repo 代理，直接调用 GitHub 公开 API（失败静默，不影响编辑） */
async function fetchGitHubRepo(url: string): Promise<{ name: string; stars: number; language: string; description: string } | null> {
