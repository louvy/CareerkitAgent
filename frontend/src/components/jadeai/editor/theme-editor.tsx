...
import { Slider } from '@/components/jadeai/ui/slider';
...
import {
  ...
  SelectTrigger,
  SelectValue,
} from '@/components/jadeai/ui/select';
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
} from '@/components/jadeai/ui/popover';
import { useResumeStore } from '@/components/jadeai/editor/resume-store';
import { TEMPLATES } from '@/lib/constants';
import { templateLabelsMap } from '@/lib/template-labels';
import { TemplateThumbnail } from '@/components/jadeai/editor/template-thumbnail';
